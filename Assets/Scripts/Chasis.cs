...
public class Chasis : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        Collider[] frontBlocks = Physics.OverlapBox(frontDetector.position, detectorBoxSize / 2, frontDetector.rotation);
        Collider[] backBlocks = Physics.OverlapBox(backDetector.position, detectorBoxSize / 2, backDetector.rotation);
